                    ...
                    <div class="card-body">
                        ...
                        <form action="create.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_buku" class="form-control" id="exampleInputPassword1" placeholder="Masukan Judul Buku">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Penulis Buku</label>
                                <input type="text" name="penulis_buku" class="form-control" id="exampleInputPassword1" placeholder="Masukan Penulis Buku">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tahun Terbit Buku</label>
                                <input type="text" name="tahun_terbit" class="form-control" id="exampleInputPassword1" placeholder="Masukan Tahun Terbit Buku">
                            </div>
                            <div class="form-group">
